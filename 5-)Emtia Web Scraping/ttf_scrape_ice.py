...
while TURN<200:
    try:
        ...
        count = driver_ice.find_elements(by=By.XPATH,
                                         value=f'/html/body/div[1]/div/div[1]/div[2]/div[3]/div/div/div[2]/div/div/table/tbody')
        for i in range(1, len(count) + 1):
            try:
                item = driver_ice.find_element(by=By.XPATH,
                                               value=f'/html/body/div[1]/div/div[1]/div[2]/div[3]/div/div/div[2]/div/div/table/tbody[{i}]/tr[1]/td[1]/a')
                last = driver_ice.find_element(by=By.XPATH,
                                               value=f'/html/body/div[1]/div/div[1]/div[2]/div[3]/div/div/div[2]/div/div/table/tbody[{i}]/tr[1]/td[2]')
                change = driver_ice.find_element(by=By.XPATH,
                                                 value=f'/html/body/div[1]/div/div[1]/div[2]/div[3]/div/div/div[2]/div/div/table/tbody[{i}]/tr[1]/td[4]')
                ...
                db.insert_ttf(str("ice_" + str(TTF_prd)), TTF_lst, TTF_chg, "", "", "", datetime.now(), url_ice)
                time.sleep(0.02)
